...
public:
	...
	{
		typedef IMaterial*(__thiscall *o_FindMat)(void*, const char*, const char*, bool, const char*);
		return VT::vfunc<o_FindMat>(this, 84)(this, pMaterialName, pTextureGroupName, complain, pComplainPrefix);
	}
};
extern IMaterialSystem *p_MaterialSystem;